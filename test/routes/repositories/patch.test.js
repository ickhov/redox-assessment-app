...
describe(`PATCH ${baseURL}/:id`, () => {
    ...
    describe('error', () => {
        it('should return 400 bad request error when request body is empty after validation', async () => {
            const app = build();
            // call the API with the access token
            const res = await app.inject({
                method: 'PATCH',
        ...
        it('should return 400 validation error when id is missing', async () => {
            const app = build();
            // call the API with the access token
            const res = await app.inject({
                method: 'PATCH',
